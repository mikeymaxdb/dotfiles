...
beautiful.init(awful.util.getdir("config") .. "/themes/darkTheme/theme.lua")
...
--CPU
   ...
   cpuwidget:set_background_color("#14191b")
   cpuwidget:set_color("#ffffff")
   cpuwidget:set_gradient_colors({ "#14191b", "#ffffff", "#ffffff" })
   -- Register widget
   vicious.register(cpuwidget, vicious.widgets.cpu, "$1")
--Temp   
   tempwidget = widget({ type = "textbox" })
	 vicious.register(tempwidget, vicious.widgets.thermal, "Temp $1  ", 5, {"coretemp.0","core"})
--Volume
	volicon = widget({ type = "textbox" })
	vicious.register(volicon, vicious.widgets.volume, " Volume $1 ", 1, "Master")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "XF86AudioStop",    function () awful.util.spawn("mocp -G") end),
    awful.key({ }, "Print", function () awful.util.spawn("scrot -e 'mv $f ~/Screenshots/ 2>/dev/null'") end),
    awful.key({ modkey,           }, "Return", function () awful.util.spawn(terminal) end),
    awful.key({ modkey,           }, "[", function () awful.util.spawn("conky") end),
